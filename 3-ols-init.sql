...
GRANT SELECT ON SEC_MGR.PERSONNEL TO NORMAL_EMP;
GRANT SELECT ON SEC_MGR.P_PROJECT TO NORMAL_EMP;
GRANT SELECT ON SEC_MGR.PROJECT_MEMBER TO NORMAL_EMP;
GRANT CREATE SESSION TO NORMAL_EMP;

CREATE ROLE PROJECT_MANAGER;
GRANT SELECT ON SEC_MGR.PERSONNEL TO PROJECT_MANAGER;
GRANT SELECT ON SEC_MGR.PROJECT_MEMBER TO PROJECT_MANAGER;
GRANT SELECT, UPDATE, INSERT, DELETE ON SEC_MGR.P_PROJECT TO PROJECT_MANAGER;
GRANT SELECT ON SEC_MGR.PROJECT_BUDGET TO PROJECT_MANAGER;
GRANT CREATE SESSION TO PROJECT_MANAGER;

CREATE ROLE HR_EMP;
GRANT SELECT, INSERT, UPDATE, DELETE ON SEC_MGR.PERSONNEL TO HR_EMP;
GRANT SELECT ON SEC_MGR.P_PROJECT TO HR_EMP;
GRANT CREATE SESSION TO HR_EMP;

CREATE ROLE HR_MANAGER;
GRANT SELECT, INSERT, UPDATE, DELETE ON SEC_MGR.PERSONNEL TO HR_MANAGER;
GRANT CREATE SESSION TO HR_MANAGER;

CREATE ROLE DIRECTOR;
GRANT ALL PRIVILEGES ON SEC_MGR.PERSONNEL TO DIRECTOR;
GRANT ALL PRIVILEGES ON SEC_MGR.LOGIN_DATA TO DIRECTOR;
GRANT ALL PRIVILEGES ON SEC_MGR.P_PROJECT TO DIRECTOR;
GRANT ALL PRIVILEGES ON SEC_MGR.PROJECT_MEMBER TO DIRECTOR;
GRANT ALL PRIVILEGES ON SEC_MGR.PROJECT_BUDGET TO DIRECTOR;
GRANT ALL PRIVILEGES ON SEC_MGR.DEPARTMENT TO DIRECTOR;
GRANT ALL PRIVILEGES ON SEC_MGR.DEPARTMENT_MEMBER TO DIRECTOR;
GRANT CREATE SESSION TO DIRECTOR;

-- assign role to user

GRANT NORMAL_EMP TO tuantai, tutai, minhtai, hoangcong, thanhcong, quoccong;

GRANT PROJECT_MANAGER TO congbach, taian;

GRANT HR_EMP TO minhnhan, trongnhan;

GRANT HR_MANAGER TO nhan;

GRANT DIRECTOR TO hoangan;
...
SA_POLICY_ADMIN.APPLY_TABLE_POLICY (
    ...
    label_function => 'sec_mgr.gen_personel_label
